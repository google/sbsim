...
from smart_control.refactor.utils.time_utils import to_dow, to_hod
...
class SchedulePolicy(tf_policy.TFPolicy):
    ...
    def _normalize_actions(self, action_map: Dict[Tuple[DeviceType, SetpointName], SetpointValue]) -> Dict:
