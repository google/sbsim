...
agent learns an action policy to maximise the cumulative, or long-term reward.
...
reward function:
  ...
  * Cost: The cost of electricity and natural gas is a negative reward (cost).
  Then by minimising negative rewards/maximising positive reward, the agent
...
Cumulative productivity is the maximum potential reward, and is parameterised by
