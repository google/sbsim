...
DEFAULT_SIM_VIDEOS_DIRPATH = os.path.join(
    ROOT_DIR, "smart_control", "simulator", "videos"
)
SIM_VIDEOS_DIRPATH = os.getenv(
    "SIM_VIDEOS_DIRPATH", default=DEFAULT_SIM_VIDEOS_DIRPATH
)
