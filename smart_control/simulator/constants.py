...
DEFAULT_SIM_VIDEOS_DIR = os.path.join(ROOT_DIR, "smart_control", "simulator", "videos")  # pylint: disable=line-too-long
SIM_VIDEOS_DIR = os.getenv("SIM_VIDEOS_DIR", default=DEFAULT_SIM_VIDEOS_DIR)
