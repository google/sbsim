...
class TrajectoryPlotter:
    ...
    def plot_actions(
        ...
        x_values = range(len(actions)) if timestamps is None else range(len(timestamps))
    ...
    def plot_rewards(
        ...
        x_values = range(len(rewards)) if timestamps is None else range(len(timestamps))
        ax.plot(x_values, rewards, label='Reward', marker='o', linestyle='-', markersize=4)
    ...
    def plot_cumulative_reward(
        ...
        x_values = range(len(rewards)) if timestamps is None else range(len(timestamps))
        ax.plot(x_values, cumulative_rewards, label='Cumulative Reward', color='green')
