...
class TrajectoryRecorderObserver(Observer):
    ...
    def _reset_trajectory_data(self):
        ...
        # Add any environment-specific state variables you want to track
        self._env_states = {
            # Example: 'temperature': []
        }
    ...
    def __call__(self, trajectory: trajectory_lib.Trajectory) -> None:
        ...
        # Record environment state variables
        # Example: self._env_states['temperature'].append(self._environment.pyenv.envs[0].current_temperature)
    ...
    def _save_trajectory(self):
        ...
        trajectory_data = {
            ...
            'environment_states': self._env_states
        }
        
        # Create filename and save
        episode_file = os.path.join(self._save_dir, f'episode_{self._episode_count}.json')
        with open(episode_file, 'w') as f:
            json.dump(trajectory_data, f, indent=2)
        
        logger.info(f"Saved trajectory data for episode {self._episode_count} to {episode_file}")
    ...
    def _generate_plots_for_episode(self):
        ...
        action_plot_path = os.path.join(self._plots_dir, f'episode_{episode_num}_action_plot.png')
        ...
        reward_plot_path = os.path.join(self._plots_dir, f'episode_{episode_num}_reward.png')
        ...
        cum_reward_plot_path = os.path.join(self._plots_dir, f'episode_{episode_num}_cum_reward.png')
